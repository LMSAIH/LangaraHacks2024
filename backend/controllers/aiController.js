    ...
    messages: [
      {
        ...
        all the stocks summed must be below the income, if the income is insufficient return 0 in the amount. Only choose the ones you think have the best value best on their general reputation. Do not include line breaks`,
      },
    ],
    max_tokens: 100,
  });
